...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { email: @professor.email, foto: @professor.foto, matricula: @professor.matricula, nome: @professor.nome, senha: @professor.senha }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { email: @professor.email, foto: @professor.foto, matricula: @professor.matricula, nome: @professor.nome, senha: @professor.senha }
    assert_redirected_to professor_path(assigns(:professor))
  end
